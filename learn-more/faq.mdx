...
A user needs the Tandemn CLI, the server URL from an administrator, and a valid prompt file.
...
An administrator needs a machine with Docker Compose support, access to the cluster resources Tandemn will manage, and the Tandemn server release bundle.
